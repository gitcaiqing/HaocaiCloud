...
INSERT INTO tb_om_config(id, config_uuid,project_type,project_version, config_type, config_url, config_content,
	status, created_time,created_by,updated_time,updated_by,version ) values
(1, 'uuid01','CTSERVER','CTSERVER2.7.0', 'search-server','https://yunpan.kedacom.com/f/1171f6b0590c4ff58215/','{
	"configMigrations":[
		{
			"configs":[
				{
