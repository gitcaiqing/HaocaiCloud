...
function initTable(){
	...
	$("#table").bootstrapTable({
		url:"${base}/om/deployPackage/listDeployPackage",
        ...
        columns: [
            ...
            {title: '海豚版本',field: 'dolphinVersion',align: 'center'},
			{title: '部署包名',field: 'packName',align: 'center'},
			{title: '部署包地址',field: 'packUrl',align: 'center'},
